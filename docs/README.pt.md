...
> 🇧🇷 **Esta tradução ainda não está disponível.**
>
> O README canônico está em [inglês](../README.md).
> Uma tradução para português será adicionada em breve.
> Contribuições são bem-vindas — abra uma PR com `docs/README.pt.md`.

---

**Agent Royo Learn** is a local institutional learning engine for AI agents.

→ [Read the full documentation in English](../README.md)