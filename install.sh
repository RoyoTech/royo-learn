...
#
# DEPRECATED as of v1.0.0: the project is Windows-only. No Linux/macOS
# binaries are published from v1.0.0 onward. For the current release
# pipeline use `install.ps1` (PowerShell) on Windows.
#
# This script remains in the repo for users pinned to v0.x releases
# (≤v0.3.0-rc1). It will not receive updates.
#
